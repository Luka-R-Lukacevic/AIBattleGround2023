...
blackInventar = [[2, 1, 1, 1, 2, 2, 2, 0, 1], [2, 1, 1, 1, 2, 2, 2, 0, 1]]
whiteInventar = [[2, 1, 1, 1, 2, 2, 2, 0, 1], [2, 1, 1, 1, 2, 2, 2, 0, 1]]
        ...
        for x in [i - 1, i, i + 1]:
            for y in [j - 1, j, j + 1]:
                if 0 <= x <= 11 and 0 <= y <= 11:
                    ...
                    if board[x][y][0] != color and not (x == i and y == i):
...
board2 = [[None, None, None, None, None, None, None, None, None, None, None, None],
         ['BP', 'BP', 'BP', 'BP', 'BP', 'BP', 'BP', 'BP', 'BP', 'BP', 'BP', 'BP'],
         [None, None, None, None, None, None, None, None, None, None, None, None],
         [None, None, None, None, None, None, None, None, None, None, None, None],
         [None, None, None, None, None, None, None, None, None, None, None, None],
